     ...
     <div className="bottom-home flex ">
      <div className="flex justify-center font-extrabold  items-center bottom-home bg-blue-100 h-200">
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <button  type="button" className=" bottom-button w-full h-10 bg-ICblue px-10 rounded-lg" onClick={()=>router.push('/createRoom')}>
    ...
    <div className="bottom-home flex ">
      <div className="flex justify-center font-extrabold  items-center bottom-home bg-blue-100 h-200">
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <button type="button" className=" bottom-button w-full h-10 bg-ICblue px-10 rounded-lg" onClick={()=>router.push('/rooms')}>
